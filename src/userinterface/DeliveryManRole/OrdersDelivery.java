...
public class OrdersDelivery extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(240, 249, 252));

        deliveryTable.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
        ...
        btnAssignToMe.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
    ...
    private void populateTable() {
        ...
        for(Restaurant r: restos)
        {
            ...
            {
                String[] row = {r.getName(),f.getCustomer(),f.getOrder_item(),f.getDate(),f.getOrder_status(),f.getOrderId()};
                dm.addRow(row);
            }
        }
