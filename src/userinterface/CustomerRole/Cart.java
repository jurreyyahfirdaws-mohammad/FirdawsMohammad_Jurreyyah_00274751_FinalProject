...
public class Cart extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cartTable.setBackground(new java.awt.Color(230, 239, 236));
        cartTable.setForeground(new java.awt.Color(231, 246, 250));
    ...
    private void OrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OrderActionPerformed
        ...
        {
           order = new Order();
           order.setOrder_item(cm.getRest_item());
    ...
    public void populateTable() {
        ...
        {
            String[] row = {cm.getRestaurant(),cm.getRest_item()};
            df.addRow(row);
