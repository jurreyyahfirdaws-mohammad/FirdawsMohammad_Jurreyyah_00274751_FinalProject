...
public class manageOrders extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(223, 234, 244));

        jLabel1.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
        jLabel1.setText("All available Orders");

        ordersAvailble.setBackground(new java.awt.Color(218, 232, 242));
        ...
        btnAccept.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 12)); // NOI18N
        ...
        btnAssignDel.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 12)); // NOI18N
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        DefaultTableModel df = (DefaultTableModel) ordersAvailble.getModel();
          ...
          fo.setOrder_item(item);
          fo.setDate(date);
          fo.setRestaurant(resto.getName());
          fo.setOrder_status("Order Accepted");
          orders.add(fo);
    ...
    private void delDropDownActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delDropDownActionPerformed
        ...
        delItem.setText(f.getOrder_item());
    ...
    private void btnAssignDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignDelActionPerformed
        ...
        f.setOrder_status("DeliveryMan Assigned");
        populatetree();
        delCusto.setText("");
        delItem.setText("");
    ...
    private void populatetree() {
        ...
        for(Customer c: customers)
        {
            ...
            for(Order o: orders)
            {
                ...
                {
                    String[] row = {c.getCustomerName(),o.getOrder_item(),o.getEntryDateTime().toString()};
                    dt.addRow(row);
                }
            }
        }
        ...
        {
            String[] row = {f.getCustomer(),f.getOrder_item(),f.getOrder_status(),f.getDeliveryMan(),f.getCust_review(),f.getOrderId(),f.getDate()};
            df.addRow(row);
